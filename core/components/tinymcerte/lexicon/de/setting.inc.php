...
$_lang['setting_tinymcerte.external_config_desc'] = 'Pfad zu einer externen JSON-Konfigurationsdatei. Sie wird mit den Standardeinstellungen des Systems verschmolzen.';
...
$_lang['setting_tinymcerte.links_across_contexts_desc'] = 'Listet beim Erstellen von internen Links im Editor Ressourcen aus anderen Kontexten auf. Ansonsten werden nur Ressourcen aus demselben Kontext aufgelistet.';
...
$_lang['setting_tinymcerte.remove_script_host_desc'] = 'Entfernt den Protokoll- und Hostteil von URLs, die vom MCFileManager zurückgegeben werden. (Wird nur verwendet, wenn relative_urls ausgeschaltet ist.)';
